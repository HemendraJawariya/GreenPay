      ...
      {!isAuthenticated ? (
        <>
          <Button className="cursor-pointer" variant="outline" asChild>
            <Link href="/login" aria-label="Login to GreenPay account">
              Login
            </Link>
          </Button>
          <Button
            ...
            asChild
          >
            <Link href="/register" aria-label="Register GreenPay account">
              Register
            </Link>
          </Button>
        </>
          ...
          <DropdownMenuContent className="p-3" align="end">
            {user?.role === "ADMIN" && (
              <>
                ...
                <DropdownMenuItem asChild className="cursor-pointer">
                  <Link href="/admin/petugas">Staff Management</Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild className="cursor-pointer">
            ...
            {user?.role === "PETUGAS" && (
              <>
                ...
                <DropdownMenuItem asChild className="cursor-pointer">
                  <Link href="/trash/verify">Deposit Verification</Link>
                </DropdownMenuItem>
              </>
            )}
            ...
            {user?.role === "USER" && (
              <>
                ...
                <DropdownMenuItem asChild className="cursor-pointer">
                  <Link href="/trash">Trash Deposit</Link>
                </DropdownMenuItem>
              </>
            )}
            <DropdownMenuSeparator />
