...
function TrashDepositPage() {
  ...
  function countdownDisplay(seconds: number) {
    ...
    return `${minutes} Minute ${s} Second`;
  }
  ...
  const downloadQRCode = () => {
    ...
    try {
      ...
      img.onload = () => {
        ...
        link.download = `qr-code-deposit-${new Date().getTime()}.png`;
  ...
  const getFirstAvailableTrashType = (
    ...
    return null; // all types are already used
  };
      ...
      <section className="flex min-h-screen w-full items-center justify-center">
        <Card className="mx-auto max-w-2xl min-w-96 space-y-6 overflow-hidden p-6">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold">Trash Deposit</h2>
          </div>
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    if (newType) {
                      ...
                      toast.error("All trash types have been added");
                    }
                  }}
                >
                  <Plus /> Add
          ...
          {step === 2 && (
            <div className="space-y-4">
              <h3 className="font-semibold">Deposit Confirmation</h3>
          ...
          {step === 3 && qrData && (
            <div className="space-y-4 text-center">
              <h3 className="font-semibold">Deposit QR Code</h3>
              ...
              <p className="text-muted-foreground grid text-sm">
                ...
                <span className="text-xs">
                  {timeLeft > 0 ? (
                    ...
                    <span className="font-semibold">QR Code has expired</span>
                  )}
                </span>
              </p>
