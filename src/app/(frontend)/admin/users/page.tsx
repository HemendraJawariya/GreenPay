  ...
  return (
    <RootLayout header={<Navbar />} footer={<Footer />}>
      <section className="space-y-6 px-4 py-6 md:px-8">
        <div>
          <h3 className="text-xl font-semibold md:text-2xl">User List</h3>
          <p className="text-muted-foreground text-sm md:text-base">
            Manage registered user data in the system. View account information, update user details, or delete users if necessary.
          </p>
        </div>
