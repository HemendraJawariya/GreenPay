  ...
  async function handleUpdateRank() {
    startTransition(async () => {
      try {
        ...
        toast.success("All user rankings updated successfully! 🎉");
      } catch (error) {
      ...
      <section className="space-y-6 py-6">
        <div className="space-y-1 text-center">
          ...
          <p className="text-muted-foreground text-sm">
            This feature is used to update the ranking of all users based on their latest transactions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4">
          <Card className="hover:border-primary p-6 transition-all duration-300 hover:shadow-[0_0_10px_4px_rgba(166,255,0,0.4)]">
            <CardHeader>
              ...
              <CardDescription>
                Update user rankings on the leaderboard.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button
